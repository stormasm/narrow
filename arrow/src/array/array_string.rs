...
use super::{
    array::print_long_array, raw_pointer::RawPtrBox, Array, ArrayData, GenericBinaryArray,
...
impl<Ptr, OffsetSize: OffsetSizeTrait> FromIterator<Option<Ptr>> for GenericStringArray<OffsetSize>
where
    Ptr: AsRef<str>,
{
